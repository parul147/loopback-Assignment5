...
let AuthMetadataProvider = class AuthMetadataProvider {
     ...
     */
    value() {
        return decorator_1.getAuthenticateMetadata(this.controllerClass, this.methodName);
    }
};
AuthMetadataProvider = __decorate([
    __param(0, context_1.inject(core_1.BindingKeys.Context.CONTROLLER_CLASS)),
    __param(1, context_1.inject(core_1.BindingKeys.Context.CONTROLLER_METHOD_NAME)),
