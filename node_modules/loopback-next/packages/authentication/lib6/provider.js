...
let AuthenticationProvider = class AuthenticationProvider {
     ...
     */
    value() {
        return (request) => __awaiter(this, void 0, void 0, function* () { return yield getAuthenticatedUser(this.strategy, request); });
    }
};
 ...
 * ```
 */
function getAuthenticatedUser(strategy, request) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const user = yield strategyAdapter.authenticate(request);
        return user;
    });
}
